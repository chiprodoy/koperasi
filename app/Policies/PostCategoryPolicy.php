...
class PostCategoryPolicy
{
    ...
    {
        return $user->isRole(Role::SUPERADMIN) || $user->hasPermission('read',$postCategory->slugs);
    ...
    {
        return $user->isRole(Role::SUPERADMIN) || $user->hasPermission('create',PostCategory::class);
    ...
    {
        return $user->isRole(Role::SUPERADMIN) || $user->hasPermission('update',PostCategory::class);
