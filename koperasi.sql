...
insert  into `anggotas`(`id`,`uuid`,`nomor_anggota`,`nik`,`nama`,`tgl_lahir`,`jenis_kelamin`,`pekerjaan`,`alamat`,`kelurahan`,`kecamatan`,`kota`,`provinsi`,`telepon`,`nama_ibu`,`photo`,`tgl_mulai_anggota`,`status_keanggotaan`,`jenis_keanggotaan`,`created_at`,`updated_at`,`deleted_at`) values (1,'d0ceedce-2a1a-4701-92db-97616adfb01b','2025072000001','001','tes','2020-02-04',1,NULL,'tes','hh','hh','Kab. PALI','Sumatera Selatan','08123','tes',NULL,'2025-07-16 00:00:00',1,2,'2025-07-20 12:16:51','2025-07-20 12:16:51',NULL);
