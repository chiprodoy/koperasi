            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <a href="{{ route('admin.soal-kepribadian.create') }}" class="btn btn-primary mb-3">Tambah data</a>
                        <h5>Daftar Soal Kepribadian</h5>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($questions as $index => $question)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="pt-2">
                                                    <a href="{{ route('admin.soal-kepribadian.edit', $question->id) }}"
                                                    ...
                                                    <div class="modal fade" id="tooltipmodal{{ $question->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="{{ route('admin.soal-kepribadian.destroy', $question->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
